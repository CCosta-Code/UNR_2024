...
# Parámetros
target = ['nmv_UDS_imp']
response_features = ['cost_USD_imp','visits_imp','visitors_imp','visitors_pur_imp','orders_imp','clicks_imp','impressions_imp',
                     'nmv_USD_imp','total_units_net_imp'] 
...
columns_predictors_s = [c for c in data.columns if c not in ['date','campaign','week_day', 'month_day', 'year_day', 'month_year','is_week_day'] + response_features]
# El budget tengo que incluirlo sí o sí en el modelo
